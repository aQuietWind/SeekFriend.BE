...
public class ConfigKeyEnum {
    ...
    public static final String Ai_Chat_Params_Rules_Config="aichat.self.params.rules";
    public static final String Ai_Chat_Redis_Key_Config="aichat.self.redis.key";
    public static final String Ai_Chat_Caffeine_Config="aichat.self.jvm-caffeine";
